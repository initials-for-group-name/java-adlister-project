                            ...
                            <div class="pr-6 pl-6 pb-6 pt-2">
                                ...
                                <div class = "flex justify-center items-center space-between w-full ">
                                    ...
                                    <form action="/profile" method="POST">
                                        <button type="submit" name="ad.id" value="${ad.id}" class="w-[6em] mr-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><a href="/user-profile">Edit</a></button>
