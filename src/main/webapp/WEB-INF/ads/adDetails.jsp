    ...
    <aside id="logo-sidebar" class="w-64 h-screen pt-20 bg-white border-l border-gray-200 " aria-label="Sidebar">
        <div class="h-full px-2 pb-4 overflow-y-auto bg-white">
            <div class="flex flex-col pb-3">
                ...
                <div class="text-[15px] mb-5 text-black-400"><p> ${ad.color}</p></div>
                ...
                <a href="/ads" class="text-xl block mt-[15em] py-2 pl-3 pr-4 text-gray-700  md:p-0 dark:text-gray-700 dark:hover:text-gray-400">Back to Ads</a>
